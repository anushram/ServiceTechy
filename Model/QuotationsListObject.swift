...
class QuotationsListObject: Mappable {
    ...
    var jobstatusid: Int
    var mobile: String
    var quotationamount: Double
    var quotationcreationdate: String
    ...
    init() {
        ...
        self.jobstatusid = 0
        self.mobile = ""
        self.quotationamount = 0.0
        self.quotationcreationdate = ""
        self.quotedate = ""
        self.quoteday = ""
        self.quotetime = ""
    }
    ...
    //self.mobile <- map["mobile"]
        ...
        self.mobile <- map["mobile"]
        self.quotationamount <- map["quotationamount"]
        self.quotationcreationdate <- map["quotationcreationdate"]
